...
class CalendarRepositoryLocal: CalendarRepository {
    ...
    val items = listOf(
        ...
        AdventCalendarItem(day = 6, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 7, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 8, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 9, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 10, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 11, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 12, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 13, imageResId = R.drawable.day1, isUnlocked = false),
        AdventCalendarItem(day = 14, imageResId = R.drawable.day1, isUnlocked = false),
    ...
    override fun getCalendarItems() = items.shuffled()
